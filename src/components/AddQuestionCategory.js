            ...
            <div className="container-fluid">
                <form >
                    <div className="form-group d-flex flex-column bd-highlight mb-2">
                        ...
                        <div className="row p-2 bd-highlight align">
                        {/* <div className="form-check col col-2 form-check-inline"></div> */}
                        <div className="form-group  col-2 ">
                            <label className="font-weight-bold  " >Select Category</label>
                            </div>
                            <div className="form-group  col-3 ">
                            <select name="parent" className="form-control" id="exampleFormControlSelect1" onChange={this.handleChange}>
