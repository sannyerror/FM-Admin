				...
				<form>
					<div className="form-group d-flex flex-column bd-highlight mb-2">
						<div className="row p-2 bg-primary text-white">
							{Org_Name
								? `Configure FirstMatch® Tool for ${Org_Name}:`
						...
						{Org_Name ? (
							<div className="ml-5 mt-3">
								<div className="row p-2 bd-highlight">
									...
									>
										<Link
											to={`/admin/questions-configure/Org=${Org_Name}&id=${Org_Id}`}
										>
									...
									<div className="col col-3">
										...
										<div className="row">
											<span className="text-center">
												Click on above to select an Image
											</span>
										</div>
										<div className="row">
											<span className="text-danger small">
												Logo should be in PNG/JPEG format and size should be
												less or equal to 10kb. 120X40 px - Ideal size
											</span>
										</div>
										<div className="row">
										...
										{this.state.Organizations &&
											this.state.Organizations?.map((org, i) => (
												<option
													key={i}
													value={org.id}
													selected={this.state.org === org.name}
												>
													{org.org_name}
												</option>
											))}
						...
						<div className="col col-3" style={{ alignContent: "center" }}>
							<PhotoshopPicker
								...
								onChange={(updatedColor) =>
									this.setState({ header_color: updatedColor.hex })
								}
